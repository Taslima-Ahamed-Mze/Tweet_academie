                ...
                '<div style="display:flex; flex-direction:column; width :100%;">' .
                    ...
                    '<div style="display:flex;">' .
                        ...
                        '<div class="titre_contenu_tweet" style="width:80%;>'.
                            '<p>' .
                            '<a href="search_profil.php?pseudo='.$donnees['pseudo'].'" class="link_profil"> <span class="p_nom_tweet">'.'<b>'. $donnees['surname'] .'</b> '. '<span style="color:grey;">'.'@'. $donnees['pseudo'] .'</a> - '. $donnees['tweet_date'] . '</span></span>' .
                                '<br>' .
                                '<span class="contenu_tweet">' .
                                    $new_string .   
                                '</span>' .
                        ...
                        '<div class="new_tweet" style="padding:10px; margin-right:10px;">' .
                            '<div class="mini_photo_profil" style="background-image: url(\'profil/image/'. $donnees_rep['profile_picture'] .'\');"></div>' . 
                                '<div class="titre_contenu_tweet">'.
                                    ...
                                    '<p>' .
                                        '<a href="search_profil.php?pseudo='.$donnees_rep['pseudo'].'" class="link_profil">'.'<span class="p_nom_tweet">'.'<b>'. $donnees_rep['surname'] .'</b> '. '<span style="color:grey;">'.'@'. $donnees_rep['pseudo'] .'</a> - '. $donnees_rep['tweet_date'] . '</span></span>' .
                    ...
                    '<div style="display:flex; flex-direction:column; width :100%;">' .
                        ...
                        '<div style="display:flex;">' .
                            ...
                            '<div class="titre_contenu_tweet" style="width:90%;>'.
                                '<p>' .
                                    '<a href="search_profil.php?pseudo='.$donnees['pseudo'].'" class="link_profil">'.'<span class="p_nom_tweet">'.'<b>'. $donnees['surname'] .'</b> '. '<span style="color:grey;">'.'@'. $donnees['pseudo'] .'</a> a retweeté : '. '</span></span>' .
                                    '<br>' .
                                '</p>' .
